...
final testHomeElement = HomeElement('Lampe de salon', 'Allumée', Icons.lightbulb_outline);
final testHomeElement3 = HomeElement('Lampe de salon', 'Allumée', Icons.lightbulb_outline);
final testHomeElement4 = HomeElement('Lampe de salon', 'Allumée', Icons.lightbulb_outline);
final testHomeElement5 = HomeElement('Lampe de salon', 'Allumée', Icons.lightbulb_outline);

class _HomeState extends State<Home> {
  List<HomeElement> _elements = [testHomeElement, testHomeElement3, testHomeElement4, testHomeElement5];

  @override
  void initState() {
    super.initState();
    // Récupérer les informations sur les éléments de la maison connectée ici
    // ...
  }
                ...
                Row(
                  ...
                  children: <Widget>[
                    IconButton(
                      ...
                      onPressed: () {
                        // Gérer le contrôle de l'élément de la maison connectée ici
                        // ...
                      },
                    ),
                    IconButton(
                      ...
                      onPressed: () {
                        // Gérer les paramètres de l'élément de la maison connectée ici
                        // ...
                      },
                    ),
                  ],
...
class HomeElement {
  ...
  HomeElement(this.name, this.value, this.icon);
}
